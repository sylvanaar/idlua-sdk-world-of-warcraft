...
function CommentatorGetPartyInfo() end
...
function EJ_GetAvailableClasses() end
function EJ_GetClassFilter() end
...
function EJ_SetClassLootFilter() end
...
function GetExtraBarOffset() end
...
function GetMaxMultisampleFormatOnCvar() end
